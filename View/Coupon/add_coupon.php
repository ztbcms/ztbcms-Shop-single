                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div class="col-xs-4">
                                                <input name="start_time" type="date" value="0" class="form-control" placeholder="使用起始时间" />
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div class="col-xs-4">
                                                <input name="end_time" type="date" value="0" class="form-control" placeholder="过期时间" />
                                            </div>
                                        </div>
                                    </td>
                                </tr>
