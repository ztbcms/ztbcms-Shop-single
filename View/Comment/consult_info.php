...
<script>
    new Vue({
        ...
        methods: {
            getDetail: function(){
                var that = this;
                $.ajax({url: "", type: 'post', data: {'id': '<?php echo $id;?>'}, dataType: 'json',
                    success:function (res){
                        if(res.status){
                            ...
                            layer.alert(res.msg,function(){
                                window.location.href = "{:U('Comment/ask_list')}";
                            });
                        }
                    }
                });
            ...
            doReply: function () {
                ...
                $.ajax({url: "{:U('Comment/addConsult')}", type: 'post', data: {'id': '<?php echo $id;?>', 'content': content}, dataType: 'json',
                    success:function (res){
                        $('#content').val('');
                        layer.alert(res.msg,{
                            icon: res.icon
