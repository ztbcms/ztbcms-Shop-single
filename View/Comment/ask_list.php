                                ...
                                <tbody>
                                    ...
                                    <tr v-for="item in commentList">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="javascript:void(0);" @click="delAsk(item.id)" id="button-delete6" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="删除"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
